...
| Resource | What you get |
|----------|----------------|
| [examples/README.md](../examples/README.md) | Table of **`examples/*`** packages: minimal run, OpenAI + tools, **`wait`** in the console, RAG, multi-agent, Express BFF, Telegram-shaped gateway mock, and how to run them. |

### Integration and product plans (drafts)

| Resource | What you get |
|----------|----------------|
| [plan-rest.md](./plan-rest.md) | REST API direction. |
