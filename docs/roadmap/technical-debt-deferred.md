...
| **Template parity** | Not all CLI templates may exercise every runtime path (e.g. `runStore`, `onWait`); align templates with [`06-definition-syntax.md`](../reference/core/06-definition-syntax.md) over time. |
...
| **`SECURITY.md`** | Vulnerability reporting path (e.g. GitHub **Security** → **Advisories**, or a dedicated security contact); separate from [`11-scope-and-security.md`](../reference/core/11-scope-and-security.md) (engine semantics). |
