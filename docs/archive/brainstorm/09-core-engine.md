...
This document **summarizes** the execution engine specification documented in [`docs/reference/core/`](../../reference/core/README.md). It bridges brainstorm (vision) and detailed technical contracts.
...
Detail: [`01-purpose.md`](../../reference/core/01-purpose.md).
...
Diagram and flow: [`02-architecture.md`](../../reference/core/02-architecture.md).
...
Detail: [`03-execution-model.md`](../../reference/core/03-execution-model.md).
...
Detail: [`04-protocol.md`](../../reference/core/04-protocol.md). JSON shapes and `Step`: [`06-definition-syntax.md`](../../reference/core/06-definition-syntax.md).
...
Detail: [`05-adapters-contracts.md`](../../reference/core/05-adapters-contracts.md), [`13-adapters-infrastructure.md`](../../reference/core/13-adapters-infrastructure.md).
...
Success criteria, risks, implementation order: [`mvp.md`](../../roadmap/mvp.md).
...
Detail and TS reference types: [`06-definition-syntax.md`](../../reference/core/06-definition-syntax.md).
...
Detail: [`11-scope-and-security.md`](../../reference/core/11-scope-and-security.md).
...
Detail: [`14-communication-multiagent.md`](../../reference/core/14-communication-multiagent.md).
...
[`07-llm-adapter.md`](../../reference/core/07-llm-adapter.md) · [`08-context-builder.md`](../../reference/core/08-context-builder.md) · [`09-skills.md`](../../reference/core/09-skills.md)
...
Detail: [`10-errors-parsing-and-recovery.md`](../../reference/core/10-errors-parsing-and-recovery.md).
...
Detail: [`15-consumers.md`](../../reference/core/15-consumers.md).
...
Declared origin in core: derived and reorganized from `docs/archive/brainstorm/` and the *Agentes AI* thread; this `09` returns the summarized view to the brainstorm for readers who start from the ideas folder.
