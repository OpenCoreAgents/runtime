...
Project synthesis document. Not final technical specification — see `docs/reference/core/` for implementation contracts.
...
| **BullMQ (primary)** | Redis job queues — **first implementation** for async `run`/`resume`, scheduled `wait`, optional MessageBus; workers call the same engine entry points as SDK/REST ([`core/13-adapters-infrastructure.md`](../../reference/core/13-adapters-infrastructure.md#job-queue-adapter-primary-bullmq)) |
...
| Doc | Topic |
|-----|-------|
| [`core/03-execution-model.md`](../../reference/core/03-execution-model.md) | Loop, Run entity, wait/resume |
| [`core/05-adapters-contracts.md`](../../reference/core/05-adapters-contracts.md) | MemoryAdapter and ToolAdapter contracts |
| [`planning/mvp.md`](../../roadmap/mvp.md) | MVP scope and Upstash integration |
| [`core/06-definition-syntax.md`](../../reference/core/06-definition-syntax.md) | Full define/load/run shapes |
| [`core/11-scope-and-security.md`](../../reference/core/11-scope-and-security.md) | SecurityLayer and multi-tenant scopes |
| [`core/14-communication-multiagent.md`](../../reference/core/14-communication-multiagent.md) | MessageBus and request-reply patterns |
