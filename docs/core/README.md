...
| [05-adapters-contracts.md](./05-adapters-contracts.md) | **MemoryAdapter**, **ToolAdapter**, **RunStore**; hooks vs adapters; multi-agent note; **`adapters-http-tool`**; **`dynamic-definitions`** (pointers to 20 / 21) |
| [06-adapters-infrastructure.md](./06-adapters-infrastructure.md) | **BullMQ** (primary), **QStash**; **`adapters-redis`** (TCP); **Upstash REST** + vector |
