...
Retrieval-augmented generation combines **vector search** with an LLM. This demo registers this file in a catalog (`system_ingest_rag_source` by id), then runs `system_vector_search` on the chunks.
