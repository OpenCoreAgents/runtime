/**
 * After `Agent.define`, mount **`createRuntimeRestRouter`** — routes match **`docs/roadmap/plan-rest.md`** (fixed **`projectId`**; no **`messageBus`** here so **`POST …/send`** returns **501**).
 */
  ...
  createRuntimeRestRouter({
    ...
    swagger: {
      info: {
        ...
        version: "0.0.0",
        description: "OpenAPI for routes on this demo (see docs/roadmap/plan-rest.md).",
      },
    },
  }),
);
