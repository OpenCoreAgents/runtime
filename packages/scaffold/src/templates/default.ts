    ...
    "package.json": JSON.stringify(
      {
        ...
        dependencies: {
          ...
          ...(llm === "openai"
            ? { "@opencoreagents/adapters-openai": "^0.0.0" }
            : llm === "anthropic"
              ? { "@opencoreagents/adapters-anthropic": "^0.0.0" }
              : {}),
          ...(adapter === "redis"
            ? { "@opencoreagents/adapters-redis": "^0.0.0", ioredis: "^5" }
            : {}),
          ...(adapter === "upstash" ? { "@opencoreagents/adapters-upstash": "^0.0.0" } : {}),
        },
        devDependencies: {
          "@types/node": "^22",
          tsx: "^4",
...
`,
    ...
    "agents/example-agent.ts": `import { Agent, Session, type AgentRuntime, type SessionOptions } from "@opencoreagents/core";
...
`,
    ...
    "tools/save-memory.ts": `import { Tool } from "@opencoreagents/core";
...
`,
    ...
    "skills/example-skill.ts": `import { Skill } from "@opencoreagents/core";
...
Generated by \`@opencoreagents/scaffold\`.
